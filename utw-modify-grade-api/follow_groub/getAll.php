        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            while($row = $select_stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                foreach ($activities as $atv) {
                    ...
                    $score_old = null;
                    if (isset($atv->score_old)) {
                        $score_old = $atv->score_old;
                    }
                    ...
                    array_push($data_item_activity, $data_row_activity);
                }
                ...
                $data_row = array(
                    ...
                    "user_ids" => $user_ids,
                    "activity" => json_encode($data_item_activity),
