...
const followClassGetAllSuccess = require("./controllers/follow-class-getall-success");
app.post(endpoint + "/follow-class-getall-success", cors(corsOptions), followClassGetAllSuccess);
